...
const AustinLuxuryHomes = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Austin Luxury Homes for Sale | Austin Luxury Real Estate | Echelon Property Group"
