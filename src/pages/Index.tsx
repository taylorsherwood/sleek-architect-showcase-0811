    ...
    <section ref={sectionRef} id="hero-section" className="relative min-h-screen flex flex-col justify-end overflow-hidden bg-primary">
      ...
      <div className="relative z-10 container mx-auto px-6 pb-32 md:pb-28 lg:pb-36 pt-36 md:pt-32 lg:pt-48">
        <div className="max-w-[780px] md:max-w-[620px] lg:max-w-[780px] relative">
          ...
          <p style={{ ...anim("0.5s"), fontFamily: '"Jost", sans-serif', fontSize: "10px", letterSpacing: "0.12em", color: "rgba(255,255,255,0.40)", marginTop: "14px", textTransform: "uppercase" }}>
            View active and off-market inventory
          </p>
