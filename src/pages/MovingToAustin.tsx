...
const faqs = [
  { question: "What is the cost of living in Austin compared to other major cities?", answer: "Austin's cost of living is significantly lower than San Francisco, New York, and Los Angeles. Luxury homes that cost $5-10M in coastal markets can be found for $2-5M in Austin's top neighborhoods like West lake Hills, Barton Creek, and Lake Austin. Combined with no state income tax, Austin offers exceptional value for high-income households." },
  { question: "What are the best neighborhoods in Austin for families relocating?", answer: "West lake Hills and Barton Creek are top choices for families, offering access to the acclaimed Eanes ISD school district. Tarrytown provides walkability and central convenience with strong Austin ISD schools. Rollingwood offers small-town charm with proximity to Zilker Park and Eanes ISD enrollment." },
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Education quality is a top priority for relocating families, and Austin delivers exceptional options. The <strong className="text-foreground">Eanes Independent School District</strong>, serving West lake Hills, Barton Creek, and Rollingwood, is consistently ranked among the top districts in Texas. Westlake High School earns National Blue Ribbon recognition and sends graduates to elite universities nationwide. For families prioritizing public schools, Eanes ISD communities should be at the top of the list.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-4">
