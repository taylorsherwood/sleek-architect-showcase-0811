        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <section>
              ...
              <div className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  Echelon Property Group is an Austin-based luxury real estate firm specializing in residential, land, commercial, and investment property across Austin and the Texas Hill Country. Founded by Taylor Sherwood, a Certified Luxury Home Marketing Specialist, the firm provides strategic advisory services for buyers, sellers, and investors navigating Austin's most competitive markets.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Whether you are searching for a waterfront estate on Lake Austin, a gated compound in Spanish Oaks, a walkable home in Tarrytown, or a development parcel in the Hill Country, Echelon Property Group delivers the market knowledge, network access, and negotiation expertise to help you achieve your goals.
                </p>
              </div>
            </section>
