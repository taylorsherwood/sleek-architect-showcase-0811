            ...
            <div className="order-4 sm:order-4">
              ...
              <div className="mt-5 flex flex-col gap-1.5 items-start">
                <a href="https://www.linkedin.com/in/taylorsherwood/" target="_blank" rel="noopener noreferrer nofollow"
                  className="inline-flex items-center gap-2 transition-colors duration-300 text-white/55 hover:text-[#b9a06c]"
                  style={{ fontFamily: '"Jost", sans-serif', fontWeight: 300, fontSize: "11.5px" }}>
            ...
            <div>
              ...
              <div>
                {[
                  ...
                  { to: "/buy", label: "Buy Homes in Austin" },
