          ...
          <div className="grid md:grid-cols-2 gap-4 lg:gap-5">
            {testimonials.map((t, i) => (
              ...
              >
                ...
                {/* Quote text */}
                <p className="<p className="text-foreground/[0.83] text-[0.9rem] md:text-[0.95rem] leading-[1.6] font-light italic mb-3.5 flex-1"> leading-[1.6] font-light italic mb-3.5 flex-1">
                  "{t.quote}"
                </p>
