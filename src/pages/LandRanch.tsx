...
const LandRanch = () => {
  return (
    <div className="land-ranch-theme min-h-screen bg-background">
        ...
        <div className="relative z-10 hidden h-full md:flex md:items-center md:pt-0 md:pb-0">
          <div className="container mx-auto px-6 md:px-12 md:-translate-y-16 lg:-translate-y-20">
            <div className="max-w-2xl">
              ...
              >
                From legacy ranches and recreational retreats to investment acreage and development
                tracts, evaluate Central Texas land through both current value and future potential with{" "}
                <Link to="/taylor-sherwood" className="underline decoration-white/40 underline-offset-4 hover:decoration-white transition-colors duration-300">Taylor Sherwood</Link>.
              </p>
      ...
      <div
        className="parallax-break hidden md:block"
        style={{ backgroundImage: "url('/__l5e/assets-v1/427eae29-289a-49f3-ba24-56018c81f69c/land-ranch-parallax-cow.jpg')", contentVisibility: "auto", containIntrinsicSize: "0 400px" } as React.CSSProperties}
        aria-hidden="true"
      />
