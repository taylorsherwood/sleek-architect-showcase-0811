...
const MOCK_DATA: Record<string, unknown> = {
  ...
  "inventory-trends": {
    ...
    series: [
      { month: "Jun", active: 1820, new: 612, sold: 540 },
      { month: "Jul", active: 1910, new: 588, sold: 521 },
      { month: "Aug", active: 1975, new: 542, sold: 498 },
      { month: "Sep", active: 1860, new: 510, sold: 532 },
      { month: "Oct", active: 1720, new: 471, sold: 555 },
      { month: "Nov", active: 1610, new: 402, sold: 489 },
      { month: "Dec", active: 1525, new: 351, sold: 458 },
      { month: "Jan", active: 1480, new: 410, sold: 470 },
      { month: "Feb", active: 1495, new: 488, sold: 502 },
      { month: "Mar", active: 1540, new: 561, sold: 548 },
      { month: "Apr", active: 1590, new: 612, sold: 590 },
      { month: "May", active: 1620, new: 645, sold: 612 },
    ],
