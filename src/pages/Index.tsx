  ...
  return (
    <section ref={sectionRef} id="hero-section" className="relative min-h-screen flex flex-col justify-end overflow-hidden bg-primary">
      ...
      <div className="absolute inset-0" style={{
        zIndex: 1,
        background: `linear-gradient(to right, rgba(8,11,26,0.52) 0%, rgba(8,11,26,0.30) 35%, rgba(8,11,26,0.05) 60%, transparent 100%)`
      }} />
...
const SearchSection = () => {
  ...
  return (
    <section className="bg-secondary/50 relative z-20" style={{ overflow: 'visible' }}>
