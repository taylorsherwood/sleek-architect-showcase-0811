...
const MarketIntelHero = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <section className="relative overflow-hidden bg-primary min-h-[500px] sm:min-h-[560px] md:min-h-[576px] lg:h-[656px] xl:h-[688px] 2xl:h-[704px] flex flex-col justify-center">
