...
const faqs = [
  { question: "Where is the best land to buy in Austin?", answer: "The strongest land opportunities depend on your intended use. For residential development, West lake Hills and Barton Creek offer premium lot values. For larger-scale development, the I-35 corridor, Highway 290 West, and Dripping Springs corridor present significant growth potential. For ranch and estate properties, the Texas Hill Country west of Austin offers stunning acreage with long-term appreciation potential." },
  { question: "How much does land cost in Austin?", answer: "Land prices in Austin vary dramatically by location and entitlements. Urban infill lots in Tarrytown or Travis Heights can exceed $1M for a quarter-acre. West lake Hills lots range from $500K to $3M+. Development parcels along growth corridors range from $5–20 per square foot. Hill Country acreage ranges from $15,000 to $100,000+ per acre depending on location and improvements." },
  ...
  { question: "Does Echelon Property Group help with land development?", answer: "We provide land advisory services including site identification, zoning and entitlement analysis, highest-and-best-use evaluation, and acquisition negotiation. While we don't build or develop directly, we work closely with developers, builders, and civil engineers to ensure our clients' land investments are positioned for maximum value." },
];
          ...
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <section className="text-center py-16 bg-secondary -mx-6 px-6">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
                Contact Taylor \"nash\" Sherwood for expert land advisory across the Austin metro and Texas Hill Country.
              </p>
