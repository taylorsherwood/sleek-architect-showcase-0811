          ...
          <div className="grid md:grid-cols-2 gap-5 lg:gap-6">
            {testimonials.map((t, i) => (
              <div
                ...
                className={`group relative rounded-lg px-6 pt-5 pb-6 md:px-8 md:pt-7 md:pb-8 flex flex-col justify-between overflow-hidden${i === testimonials.length - 1 ? " md:col-span-2 md:w-[calc(50%-0.625rem)] lg:w-[calc(50%-0.75rem)] md:mr-auto" : ""}`}
                style={{
                  opacity: 0,
