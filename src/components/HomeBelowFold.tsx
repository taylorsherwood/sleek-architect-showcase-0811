        ...
        <div className="flex flex-col justify-center bg-secondary lg:-mt-14" style={{ padding: "clamp(36px, 5vw, 64px)" }}>
          ...
          <ScrollReveal delay={180}>
            ...
            <div className="relative space-y-4 mb-14" style={{ fontFamily: '"Jost", sans-serif', fontWeight: 300 }}>
                ...
                <p className="text-foreground/70 text-[16px] leading-[1.8]">
                  This is not a volume business. It's a strategy business. In fact, 95%+ of my sales never touch MLS or Zillow.
                </p>
                <p className="text-foreground/70 text-[16px] leading-[1.8]">
            ...
            <div className="relative" style={{ maxWidth: "34rem" }}>
              ...
              {revealed && (
                <div style={{ opacity: 0, animation: "fadeUp 0.6s ease 0.4s both", zIndex: 2 }}>
                  ...
                  <Link
                    to="/reviews"
                    className="relative inline-flex items-center text-white/80 hover:text-gold transition-colors duration-[450ms] group/link mt-10"
                    style={{ fontFamily: '"Jost", sans-serif', fontSize: "11px", letterSpacing: "0.18em", textTransform: "uppercase", fontWeight: 400, textShadow: "0 1px 6px rgba(0,0,0,0.45)" }}
                  >
...
const communities = [
  { name: "Barton Creek", eyebrow: "MEDIAN SALE: $3.2M", image: "/static-assets/community-barton-creek.webp", slug: "barton-creek" },
  { name: "Lake Austin", eyebrow: "WATERFRONT ESTATES FROM $3.5M", image: "/static-assets/community-lake-austin.webp", slug: "lake-austin" },
      ...
      <div className="max-w-[1240px] mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-14 md:gap-x-10">
          {editorialArticles.map((article, i) => (
            <ScrollReveal key={article.href} delay={i * 90} className="h-full">
