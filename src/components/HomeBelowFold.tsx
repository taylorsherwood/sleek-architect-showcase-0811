...
const TrustStrip = () => {
  const items = ["RESIDENTIAL · RANCH · LAND", "ACQUISITION & DISPOSITION ADVISORY", "$155M+ CAREER SALES VOLUME"];
  return (
...
const stats = [
  { value: 155, suffix: "M+", prefix: "$", label: "Career Sales Volume", from: 50 },
