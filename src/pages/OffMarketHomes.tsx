        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <section className="flex flex-wrap items-center justify-center gap-10 md:gap-16 py-4">
              <img src={austinLuxuryNetwork} alt="Austin Luxury Network" className="h-16 w-auto object-contain mix-blend-multiply" />
              <img src={clubhouseCommission} alt="Clubhouse by Commission.co" className="h-16 w-auto object-contain mix-blend-multiply" />
              <img src={topAgentNetwork} alt="Top Agent Network Verified Member" className="h-16 w-auto object-contain mix-blend-multiply" />
            </section>
