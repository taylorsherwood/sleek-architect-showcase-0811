  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        ...
        description="Expert buyer representation for Austin luxury homes. Off-market access, concierge service, and strategic guidance from Taylor Sherwood and Echelon Property Group."
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16 max-w-2xl">
              ...
              <h2 className="text-4xl md:text-5xl font-display font-light text-architectural mb-6 whitespace-nowrap">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <Link to="/off-market-real-estate-austin" className="text-foreground hover:text-muted-foreground transition-colors duration-300 text-minimal">→ OFF-MARKET HOMES IN AUSTIN</Link>
