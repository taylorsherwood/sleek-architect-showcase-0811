  ...
  return (
    <section ref={sectionRef} className="bg-secondary relative overflow-hidden" style={{ padding: "clamp(64px, 10vw, 120px) 0" }}>
      <div ref={watermarkRef} className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden" aria-hidden="true"
        ...
        <div style={{
          width: "600px", maxWidth: "90vw", aspectRatio: "1 / 1",
            ...
            <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16">
              <div>
                ...
                <div className="space-y-6 text-muted-foreground leading-[1.7]">
                  ...
                  <p>
                    With deep expertise across Barton Creek, West lake Hills, Lake Austin, Rollingwood, 
