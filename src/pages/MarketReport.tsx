...
const faqs = [
  ...
  { question: "What price range defines luxury real estate in Austin?", answer: "In Austin, luxury real estate generally begins at $1 million for single-family homes and $500,000 for condos. The core luxury market spans $1.5M to $5M, while ultra-luxury encompasses properties above $5M. Lake Austin waterfront, West lake Hills estates, and Hill Country ranches represent the highest tier, with properties exceeding $15-25M." },
  { question: "Where are luxury home prices highest in Austin?", answer: "Lake Austin waterfront commands the highest per-property prices, with estates regularly exceeding $10M. West lake Hills and Barton Creek feature the highest concentration of $3M+ homes. Downtown Austin penthouses can exceed $5M, while Texas Hill Country ranch estates reach $30M+ for exceptional properties." },
