        ...
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-[15px] leading-relaxed max-w-2xl mx-auto mb-3">
              A curated view of transactions represented over $50m+ in 2025 sales volume across Austin’s luxury, off-market, and investment segments.
            </p>
