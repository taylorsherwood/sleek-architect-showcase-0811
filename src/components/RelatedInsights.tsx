...
const allInsightLinks: InsightLink[] = [
  ...
  { to: "/private", label: "Submit a property to our private investor network", topics: ["off-market", "private", "investor", "sell"] },
  { to: "/sell", label: "Sell your Austin home with strategic marketing", topics: ["sell", "marketing", "luxury", "homes"] },
  ...
  { to: "/best-neighborhoods-in-austin-texas", label: "Best neighborhoods in Austin Texas (2026 guide)", topics: ["neighborhoods", "relocation", "guide"] },
