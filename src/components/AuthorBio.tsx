      ...
      <div className="mt-16 pt-8 border-t border-border">
        <div className="flex items-start gap-4">
          <div className="w-16 h-16 rounded-full overflow-hidden flex-shrink-0">
            <OptimizedImage src={taylorHeadshot} alt="Taylor \"Nash\" Sherwood - Austin Real Estate Advisor" title="Taylor \"Nash\" Sherwood, Austin luxury real estate advisor" width={160} height={160} className="w-full h-full object-cover object-[50%_30%]" />
          </div>
          <div>
            <h3 className="text-lg font-medium text-foreground">Taylor "Nash" Sherwood</h3>
    ...
    <section className="mt-16 pt-8 border-t border-border">
      <div className="flex flex-col sm:flex-row items-start gap-6">
        <div className="w-20 h-20 rounded-full overflow-hidden flex-shrink-0">
          <OptimizedImage src={taylorHeadshot} alt="Taylor \"Nash\" Sherwood - Austin Real Estate Advisor" title="Taylor \"Nash\" Sherwood, Austin luxury real estate advisor" width={200} height={200} className="w-full h-full object-cover object-[50%_30%]" />
        </div>
        <div>
          <p className="text-minimal text-gold mb-2 font-extrabold">ABOUT THE AUTHOR</p>
          <h3 className="text-xl font-display font-medium text-foreground mb-2">Taylor "Nash" Sherwood</h3>
          <p className="text-sm text-muted-foreground mb-1">Austin Real Estate Advisor · Echelon Property Group</p>
          <p className="text-muted-foreground leading-relaxed mt-3">
            Taylor "Nash" Sherwood is a Certified Luxury Home Marketing Specialist (CLHMS) and top-performing Austin real estate advisor. 
