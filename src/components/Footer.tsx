...
const Footer = () => {
  return (
    <footer className="bg-[#0D0D0D] text-primary-foreground py-8" style={{ fontFamily: '"Jost", sans-serif', fontWeight: 300 }}>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                <Link to="/moving-to-austin-texas" className="block text-primary-foreground/70 hover:text-primary-foreground transition-colors">Moving to Austin</Link>
                ...
                <Link to="/best-luxury-neighborhoods-in-austin" className="block text-primary-foreground/70 hover:text-primary-foreground transition-colors">Luxury Neighborhoods</Link>
