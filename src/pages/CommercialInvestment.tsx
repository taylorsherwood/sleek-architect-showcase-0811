...
const CommercialInvestment = () => {
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title="Austin Commercial & Investment Real Estate | Echelon Property Group"
      ...
      <section id="featured-listings" className="py-28">
        <div className="container mx-auto px-6">
          <div className="max-w-7xl mx-auto">
            <div className="mb-16">
              <p className="text-minimal text-gold mb-4 font-extrabold">FEATURED OPPORTUNITIES</p>
              <h2 className="text-4xl md:text-5xl font-display font-light text-architectural mb-6">
                Commercial & Investment Listings
              </h2>
              <p className="text-muted-foreground max-w-2xl">
                A curated selection of Austin commercial real estate and investment properties.
                Contact us for complete offering memorandums and off-market opportunities.
              </p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-4xl md:text-6xl font-display font-light text-architectural mb-6">
              Ready to Acquire in Austin?
            </h2>
            <p className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Whether you're targeting a single asset or building a portfolio, Echelon Property Group
              delivers institutional-grade advisory for Austin commercial and investment real estate.
            </p>
