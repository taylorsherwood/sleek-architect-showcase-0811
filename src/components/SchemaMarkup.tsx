...
export const taylorSherwoodSchema = {
  ...
  "givenName": "Taylor",
  "familyName": "Sherwood",
  "jobTitle": "Founder & Luxury Real Estate Advisor",
  "description": "Austin REALTOR and founder of Echelon Property Group, specializing in luxury homes, commercial real estate, land, development, and off market representation across Central Texas.",
