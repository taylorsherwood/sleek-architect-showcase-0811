          ...
          <div className="max-w-4xl mx-auto space-y-16">
            ...
            <section>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <Link to="/austin-land-development-opportunities" className="text-foreground hover:text-muted-foreground transition-colors duration-300 text-minimal">→ LAND DEVELOPMENT</Link>
