  ...
  <section className="bg-background pt-12 md:pt-20">
    <div className="max-w-[1400px] mx-auto">
       <div className="grid lg:grid-cols-[minmax(480px,520px)_1fr] items-stretch" style={{ gap: 0 }}>
         ...
         <div className="relative flex items-start justify-center bg-background w-full lg:h-full overflow-hidden" style={{ padding: "16px", paddingTop: "0px" }}>
           <img
             src={taylorBoatImg}
          ...
          <ScrollReveal delay={180}>
            <div className="space-y-4 mb-8" style={{ fontFamily: '"Jost", sans-serif', fontWeight: 300 }}>
              ...
              <p className="text-foreground/70 text-[16px] leading-[1.8]">
               ...
               <div className="!mt-0 !pt-0 mb-8"><img src={taylorSignature} alt="Taylor Sherwood signature" className="block h-[160px] opacity-80 -translate-y-4" /></div>
            </div>
