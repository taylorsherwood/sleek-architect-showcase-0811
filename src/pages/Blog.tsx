                ...
                <article key={post.id} className="group h-full">
                  <Link to={post.href || `/blog/${post.id}`} className="flex flex-col h-full">
                    ...
                    <div className="grid flex-1 grid-rows-[2rem_5rem_5.5rem_auto] gap-2 md:grid-rows-[2rem_5.5rem_5.5rem_auto]">
                      ...
                      <p className="text-muted-foreground leading-relaxed line-clamp-3 overflow-hidden max-h-[4.95rem]">
                        {post.excerpt}
                      </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-muted-foreground leading-relaxed">
              ...
              <p>
                Our editorial team publishes in-depth articles across a range of topics relevant to Austin luxury real estate. Market reports analyze pricing trends, inventory levels, and demand drivers across neighborhoods like West lake Hills, Barton Creek, Lake Austin, Tarrytown, and Rollingwood. Neighborhood guides explore the lifestyle, amenities, schools, and investment potential of Austin's most sought-after communities.
              </p>
              <p>
